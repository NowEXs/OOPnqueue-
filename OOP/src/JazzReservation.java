 ...
 * @author nk
 */
public class JazzReservation extends javax.swing.JFrame {
    ...
    private void bt_confirmActionPerformed(java.awt.event.ActionEvent evt) {
        Student student = new Student(jTextField_name.getText(), jTextField_id.getText(), jTextField_lab.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JazzReservation().setVisible(true);
            }
        });
    }
