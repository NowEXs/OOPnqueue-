...
public class CheckQueueMDI extends javax.swing.JFrame {
    ...
    private void setCustomFont(Font font){
        ...
        Queue.setFont(font.deriveFont(Font.BOLD, 24));
        seat.setFont(font.deriveFont(Font.BOLD, 18));


    }
    private void setCustomTextLabelFont(Font font) {

        jLabel_name.setFont(font.deriveFont(Font.PLAIN, 13));
        jLabel_id.setFont(font.deriveFont(Font.PLAIN, 13));
        jLabel_lab.setFont(font.deriveFont(Font.PLAIN, 13));
    }
...
/**
    ...
    private void initComponents() {
        ...
        Queue.setForeground(new java.awt.Color(238,228,177));
